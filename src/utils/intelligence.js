...
export const CATEGORY_OPTIONS = [
  ...
  'Tech Reference',
  'Tech Reference/Hosting',
  'Tech Reference/Domain and DNS',
  'Tech Reference/Email',
  'Tech Reference/Cloud',
  'Tech Reference/Database',
  'Tech Reference/Authentication',
  'Tech Reference/Frontend',
  'Tech Reference/Backend',
  'Tech Reference/AI/ML',
  'Tech Reference/Computer Vision',
  'Tech Reference/DevOps',
  'Tech Reference/Deployment',
  'Tech Reference/Security',
  'Tech Reference/Analytics',
  'Tech Reference/API',
  'Tech Reference/Development Tool',
  'Tech Reference/Other',
  'Uncategorised',
];
